...
Mus89_Special_Stage_Loop05:
	dc.b	nE5, $18, nE5, $0C, nE5, $18, nE5, $0C, $18, nE5, $0C, nE5
	dc.b	$18, nE5, $0C, nE5, $18, nE5, $0C, nE5, $18, nE5, $0C, nE5
	dc.b	$18, nE5, $0C, nE5, $24
	smpsLoop            $00, $02, Mus89_Special_Stage_Loop05
	dc.b	smpsNoAttack, $03, nRst, $09, nE5, $0C, nE5, nE5, nE5, nE5, nE5, $18
	dc.b	nE5, $0C, nE5, $24, nRst, $0C, nE5, nE5, nE5, nE5, nE5, nE5
	dc.b	$18, nE5, $0C, nE5, $21, nRst, $03
...
Mus89_Special_Stage_Loop04:
	dc.b	nF5, $0C, nRst, $18, nF5, $0C, nRst, $18, nF5, $0C, nRst, $18
	dc.b	nF5, $0C, nF5, nF5, nF5, $0C, nRst, $18, nF5, $0C, nRst, $18
	dc.b	nF5, $12, nF5, $06, nF5, $0C, nF5, $24
	smpsLoop            $00, $02, Mus89_Special_Stage_Loop04
	dc.b	nF4, $0C, nRst, $18, nF4, $0C, nRst, $18, nF5, $0C, nRst, $18
	dc.b	nF5, $0C, nRst, $18, nF4, $0C, nRst, $18, nF4, $0C, nRst, $18
	dc.b	nF5, $0C, nRst, $18, nF5, $24
	smpsNop             $01
...
Mus89_Special_Stage_Loop03:
	...
	dc.b	nRst, nE7, $03, nRst, $09, nE7, $0C, nE6, nE7, nE7
	smpsCall            Mus89_Special_Stage_Call04
	dc.b	nE7, $12, nE7, $06, nE7, $0C, nE6, $24
	...
	dc.b	nE6, $0C
	smpsCall            Mus89_Special_Stage_Call05
	dc.b	nRst, nE7, $03, nRst, $09, nE7, $0C, $24
	smpsJump            Mus89_Special_Stage_Loop03

Mus89_Special_Stage_Call04:
	dc.b	nRst, $0C, nE7, $03, nRst, $09, nE7, $0C, nRst, nE7, $03, nRst
	dc.b	$09, nE7, $0C
	smpsReturn

Mus89_Special_Stage_Call05:
	dc.b	nRst, $0C, nE6, $03, nRst, $09, nE6, $0C, nRst, nE6, $03, nRst
	dc.b	$09, nE6, $0C
	smpsReturn
...
Mus89_Special_Stage_Loop02:
	...
	dc.b	nRst, nC6, $03, nRst, $09, nC6, $0C, nC6, nC6, nC6
	smpsCall            Mus89_Special_Stage_Call02
	dc.b	nC6, $12, nC6, $06, nC6, $0C, nC6, $24
	smpsLoop            $00, $02, Mus89_Special_Stage_Loop02
	smpsCall            Mus89_Special_Stage_Call03
	dc.b	nRst, nC6, $03, nRst, $09, nC6, $0C, nRst, nC6, $03, nRst, $09
	dc.b	nC6, $0C
	smpsCall            Mus89_Special_Stage_Call03
	dc.b	nRst, nC6, $03, nRst, $09, nC6, $0C, $24
	smpsJump            Mus89_Special_Stage_Loop02

Mus89_Special_Stage_Call02:
	dc.b	nRst, $0C, nC7, $03, nRst, $09, nC7, $0C, nRst, nC6, $03, nRst
	dc.b	$09, nC6, $0C
	smpsReturn

Mus89_Special_Stage_Call03:
	dc.b	nRst, $0C, nC6, $03, nRst, $09, nC6, $0C, nRst, nC6, $03, nRst
	dc.b	$09, nC6, $0C
	smpsReturn
...
Mus89_Special_Stage_Loop01:
	...
	dc.b	nRst, nA6, $03, nRst, $09, nA6, $0C, nA6, nA6, nA6
	smpsCall            Mus89_Special_Stage_Call00
	dc.b	nA6, $12, nA6, $06, nA6, $0C, nA6, $24
	smpsLoop            $00, $02, Mus89_Special_Stage_Loop01
	smpsCall            Mus89_Special_Stage_Call01
	dc.b	nRst, nA6, $03, nRst, $09, nA6, $0C, nRst, nA6, $03, nRst, $09
	dc.b	nA6, $0C
	smpsCall            Mus89_Special_Stage_Call01
...
Mus89_Special_Stage_Loop06:
	...
	dc.b	nE6, $06, $06, nE5, $03, nRst, $09, nE5, $03, nRst, $09, nE5
	dc.b	$03, nRst, $21
	smpsCall            Mus89_Special_Stage_Call06
	dc.b	nE6, $03, nRst, $15, nE6, $03, nRst, $09, nE6, $03, nRst, $21
	smpsLoop            $00, $02, Mus89_Special_Stage_Loop06
	smpsCall            Mus89_Special_Stage_Call07
	dc.b	nE6, $06, $06, nE6, nE6, nE6, nE6, nE6, nE6, nE6, nE6, nE6
	dc.b	$03, nRst, $09
	smpsCall            Mus89_Special_Stage_Call07
	dc.b	nE7, $06, $06, nE6, nE6, nE6, nE6, nE6, $09, nRst, $1B
	smpsJump            Mus89_Special_Stage_Loop06

Mus89_Special_Stage_Call06:
	dc.b	nE6, $06, $06, nE6, $03, nRst, $09, nE5, $03, nRst, $09, nE6
	dc.b	$06, $06, nE5, $03, nRst, $09, nE5, $03, nRst, $09
	smpsReturn
...
Mus89_Special_Stage_Loop00:
	dc.b	nE7, $18, nE7, $0C, nE7, $18, nE7, $0C, $18, nE7, $0C, nE7
	dc.b	$18, nE7, $0C, nE7, $18, nE7, $0C, nE7, $18, nE7, $0C, nE7
	dc.b	$18, nE7, $0C, nE7, $24
	smpsLoop            $00, $02, Mus89_Special_Stage_Loop00
	dc.b	nRst, $0C, nE7, nE7, nE7, nE7, nE7, nE7, $18, nE7, $0C, nE7
	dc.b	$24, nRst, $0C, nE7, nE7, nE7, nE7, nE7, nE7, $18, nE7, $0C
	dc.b	nE7, $21, nRst, $03
