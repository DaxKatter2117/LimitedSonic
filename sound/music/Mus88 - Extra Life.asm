...
Mus88_Extra_Life_FM2:
	...
	smpsNoteFill        $00
	dc.b	nCs7, $09, nCs6, nCs6, $06, nCs7, $18
	smpsNop             $01
	smpsStop
...
Mus88_Extra_Life_Jump00:
	smpsSetvoice        $02
	dc.b	nA4, $0C, nRst, $06, nA4, nA4, nRst, $03, nA4, $06, nRst, $03
	dc.b	nA4, $06, nA4, $18
	smpsStop
...
Mus88_Extra_Life_DAC:
	dc.b	dSnare, $12, $06, dSnare, $09, $09, $06, dSnare, $06, dSnare, dSnare, dSnare
	dc.b	dSnare, $0C
	smpsFade
