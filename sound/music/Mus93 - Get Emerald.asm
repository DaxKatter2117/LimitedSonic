...
Mus93_Get_Emerald_FM1:
	smpsSetvoice        $00
	dc.b	nE5, $06, nE5, nE6, nE6, $0C, nE6, nE6, $2A
	smpsStop

; FM2 Data
Mus93_Get_Emerald_FM2:
	smpsSetvoice        $00
	dc.b	nC5, $06, nC5, nC5, nC6, $0C, nC5, nC6, $2A
	smpsStop

; FM4 Data
Mus93_Get_Emerald_FM4:
	smpsSetvoice        $01
	dc.b	nE5, $0C, nE5, $06, nE5, $06, nRst, nE5, nRst, nE6, $2A
	smpsStop

; FM5 Data
Mus93_Get_Emerald_FM5:
	smpsSetvoice        $01
	dc.b	nC6, $0C, nC6, $06, nC6, $06, nRst, nC6, nRst, nC6, $2A
	smpsStop

; FM6 Data
Mus93_Get_Emerald_FM6:
	smpsSetvoice        $01
	dc.b	nG5, $0C, nG5, $06, nG6, $06, nRst, nG6, nRst, nG6, $2A
	smpsStop
