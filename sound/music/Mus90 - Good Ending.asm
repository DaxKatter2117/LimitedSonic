Mus90_Ending_Header:
	...
	smpsHeaderVoice     Mus90_Ending_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $05

	smpsHeaderDAC       Mus90_Ending_DAC
	smpsHeaderFM        Mus90_Ending_FM1,	$F4, $0E
	smpsHeaderFM        Mus90_Ending_FM2,	$F4, $09
	smpsHeaderFM        Mus90_Ending_FM3,	$F4, $0D
	smpsHeaderFM        Mus90_Ending_FM4,	$F4, $0D
	smpsHeaderFM        Mus90_Ending_FM5,	$F4, $17
	smpsHeaderPSG       Mus90_Ending_PSG1,	$D0, $05, $00, fTone_05
	smpsHeaderPSG       Mus90_Ending_PSG2,	$DC, $05, $00, fTone_05
	smpsHeaderPSG       Mus90_Ending_PSG3,	$00, $03, $00, fTone_04

; FM1 Data
Mus90_Ending_FM1:
	smpsSetvoice        $03
	dc.b	nRst, $60
	smpsCall            Mus90_Ending_Call00
	dc.b	nRst, $60
	smpsAlterVol        $FB
...
Mus90_Ending_Call00:
	...
	smpsLoop            $00, $02, Mus90_Ending_Call00
	smpsReturn
...
Mus90_Ending_Loop03:
	...
	smpsLoop            $00, $02, Mus90_Ending_Loop03
...
Mus90_Ending_Loop02:
	...
	dc.b	nG6, $1E
	smpsLoop            $00, $02, Mus90_Ending_Loop02
...
Mus90_Ending_Loop01:
	...
	dc.b	nD6, $1E
	smpsLoop            $00, $02, Mus90_Ending_Loop01
	smpsAlterNote       $03
	smpsAlterVol        $08
	smpsCall            Mus90_Ending_Call01
	smpsAlterVol        $F0
	smpsSetvoice        $01
...
Mus90_Ending_Loop04:
	...
	smpsNoteFill        $0C
	dc.b	$0C
	smpsLoop            $00, $0F, Mus90_Ending_Loop04
	smpsNoteFill        $03
	dc.b	nMaxPSG, $06
	smpsNoteFill        $0E
	dc.b	$12
...
Mus90_Ending_Loop00:
	...
	smpsLoop            $00, $03, Mus90_Ending_Loop00
