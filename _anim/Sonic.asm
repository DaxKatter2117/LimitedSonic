...
SonAni_Walk:	dc.b $FF, fr_Run11, afEnd
		even
SonAni_Run:	dc.b $FF,  fr_Run11, afEnd
		even
SonAni_Roll:	dc.b $FE,  fr_Roll5, afEnd
		even
SonAni_Roll2:	dc.b $FE,  fr_Roll5, afEnd
		even
SonAni_Push:	dc.b $FD,  fr_Run11, afEnd
		even
SonAni_Wait:	dc.b $17, fr_Stand, afEnd
		even
SonAni_Balance:	dc.b $1F, fr_Stand, afEnd
		even
SonAni_LookUp:	dc.b $3F, fr_Stand, afEnd
		even
SonAni_Duck:	dc.b $3F, fr_Roll5, afEnd
		even
SonAni_Warp1:	dc.b $3F, fr_Stand, afEnd
		even
SonAni_Warp2:	dc.b $3F, fr_Stand, afEnd
		even
SonAni_Warp3:	dc.b $3F, fr_Stand, afEnd
		even
SonAni_Warp4:	dc.b $3F, fr_Stand, afEnd
		even
SonAni_Stop:	dc.b 7,	fr_Stand, afEnd
		even
SonAni_Float1:	dc.b 7,	fr_Death, afEnd
		even
SonAni_Float2:	dc.b 7,	fr_Death, afEnd
		even
SonAni_Spring:	dc.b $2F, fr_Stand, afChange, id_Wait
		even
SonAni_Hang:	dc.b 4,	fr_Death, afEnd
		even
SonAni_Leap1:	dc.b $F, fr_Death,	afEnd
		even
SonAni_Leap2:	dc.b $F, fr_Death, afEnd
		even
SonAni_Surf:	dc.b $3F, fr_Stand, afEnd
		even
SonAni_GetAir:	dc.b $B, fr_Death, afChange, id_Wait
		even
SonAni_Burnt:	dc.b $20, fr_Death, afEnd
		even
SonAni_Drown:	dc.b $2F, fr_Death, afEnd
		even
SonAni_Death:	dc.b 3,	fr_Death, afEnd
		even
SonAni_Shrink:	dc.b 3,	fr_Death, fr_Null, afBack, 1
		even
SonAni_Hurt:	dc.b 3,	fr_Death, afEnd
		even
SonAni_WaterSlide:
		dc.b 7, fr_Death, afEnd
		even
SonAni_Null:	dc.b $77, fr_Null, afChange, id_Wait
		even
SonAni_Float3:	dc.b 3,	fr_Death, afEnd
		even
SonAni_Float4:	dc.b 3,	fr_Death, afChange, id_Wait
		even
