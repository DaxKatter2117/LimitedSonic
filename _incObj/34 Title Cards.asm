...
Card_LoadConfigFinal:
		lea	(Card_ConData).l,a3
		lsl.w	#4,d0
		adda.w	d0,a3
		lea	(Card_ItemDataAlt).l,a2
		moveq	#2,d1
...
Card_ChkPos:	; Routine 2
		moveq	#4,d1		; set horizontal speed
...
Card_Delete:
		bra.w	DeleteObject
; ===========================================================================
Card_ItemData:	dc.w $E4	; y-axis position
		...
		dc.b 2,	$A
; ===========================================================================
Card_ItemDataAlt:	dc.w $D0	; y-axis position
		dc.b 2,	0	; routine number, frame	number (changes)
		dc.w $E4
		dc.b 2,	6
		dc.w $EA
...
; ---------------------------------------------------------------------------
Card_ConData:	dc.w 0,	$120, $424, $164, $FEFC, $13C, $214, $154 ; GHZ
		dc.w 0,	$120, $44C, $18C, $FEF4, $134, $20C, $14C ; LZ
		dc.w 0,	$120, $434, $174, $FEE0, $120, $1F8, $138 ; MZ
		dc.w 0,	$120, $42C, $16C, $FEFC, $13C, $214, $154 ; SLZ
		dc.w 0,	$120, $41C, $15C, $FF04, $144, $21C, $15C ; SYZ
		dc.w 0,	$120, $42C, $16C, $FF04, $144, $21C, $15C ; SBZ
