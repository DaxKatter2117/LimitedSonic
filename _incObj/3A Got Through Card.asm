...
Got_Move:	; Routine 2
		moveq	#04,d1		; set horizontal speed
...
Got_TimeBonus:	; Routine 6
		...
		addi.w	#1,d0		; add 10 to score
		subi.w	#1,(v_timebonus).w ; subtract 10 from time bonus

Got_RingBonus:
		tst.w	(v_ringbonus).w	; is ring bonus	= zero?
		beq.s	Got_ChkBonus	; if yes, branch
		addi.w	#1,d0		; add 10 to score
		subi.w	#1,(v_ringbonus).w ; subtract 10 from ring bonus
