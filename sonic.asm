...
loc_E0:
		...
		dc.b "(C)SEGA 2024.SEP" ; Copyright holder and release date (generally year)
		dc.b "LIMITEDSONIC                                    " ; Domestic name
		dc.b "LIMITEDSONIC                                    " ; International name
		if Revision=0
...
;		cmpi.w	#$1C00,d0	; has Sonic object passed $1C00 on x-axis?
		bra.s	Tit_ChkRegion	; if not, branch
...
StartGame:
		move.b	#id_Special,(v_gamemode).w ; set screen mode to $0C (level)
...
Level_LoadPal:
		...
		cmpi.b	#id_LZ,(v_zone).w ; is level LZ?
		bne.s	Level_LoadLoop	; if not, branch
...
Level_TtlCardLoop:
        ...
        tst.w   (v_framecount).l    ; has the loading screen finished
		bne.s	Level_TtlCardLoop ; if yes, branch        
...
Level_SkipTtlCard:
		...
		cmpi.b	#id_EndZ,(v_zone).w	; is level the Ending?
...
End_MoveSon2:
		...
		move.b	#fr_Stand,(v_player+obFrame).w
...
Cred_SkipObjGfx:
		...
		move.w	#540,(v_demolength).w ; display a credit for 2 seconds
		bsr.w	PaletteFadeIn
...
M_Card_GHZ:	spriteHeader		; GREEN HILL
	spritePiece	-$5C, -8, 2, 2, $26, 0, 0, 0, 0
	spritePiece	-$4C, -8, 1, 2, $20, 0, 0, 0, 0
	spritePiece	-$44, -8, 2, 2, $2A, 0, 0, 0, 0
	spritePiece	-$34, -8, 1, 2, $20, 0, 0, 0, 0
	spritePiece	-$2C, -8, 2, 2, $42, 0, 0, 0, 0
	spritePiece	-$1C, -8, 2, 2, $10, 0, 0, 0, 0
	spritePiece	-$0C, -8, 2, 2, $C, 0, 0, 0, 0
...
M_Card_LZ:	spriteHeader		; LABYRINTH
	spritePiece	-$7C, -8, 2, 2, $26, 0, 0, 0, 0
	spritePiece	-$6C, -8, 1, 2, $20, 0, 0, 0, 0
	spritePiece	-$64, -8, 2, 2, $2A, 0, 0, 0, 0
	spritePiece	-$54, -8, 1, 2, $20, 0, 0, 0, 0
	spritePiece	-$4C, -8, 2, 2, $42, 0, 0, 0, 0
	spritePiece	-$3C, -8, 2, 2, $10, 0, 0, 0, 0
	spritePiece	-$2C, -8, 2, 2, $C, 0, 0, 0, 0

	spritePiece	-$14, -8, 2, 2, $26, 0, 0, 0, 0
	spritePiece	-4, -8, 2, 2, 0, 0, 0, 0, 0
	spritePiece	$C, -8, 2, 2, 4, 0, 0, 0, 0
	spritePiece	$1C, -8, 2, 2, $4A, 0, 0, 0, 0
	spritePiece	$2C, -8, 2, 2, $3A, 0, 0, 0, 0
	spritePiece	$3C, -8, 1, 2, $20, 0, 0, 0, 0
	spritePiece	$44, -8, 2, 2, $2E, 0, 0, 0, 0
	spritePiece	$54, -8, 2, 2, $42, 0, 0, 0, 0
	spritePiece	$64, -8, 2, 2, $1C, 0, 0, 0, 0
M_Card_LZ_End
	even

M_Card_MZ:	spriteHeader		; MARBLE
	spritePiece	-$74, -8, 2, 2, $26, 0, 0, 0, 0
	spritePiece	-$64, -8, 1, 2, $20, 0, 0, 0, 0
	spritePiece	-$5C, -8, 2, 2, $2A, 0, 0, 0, 0
	spritePiece	-$4C, -8, 1, 2, $20, 0, 0, 0, 0
	spritePiece	-$44, -8, 2, 2, $42, 0, 0, 0, 0
	spritePiece	-$34, -8, 2, 2, $10, 0, 0, 0, 0
	spritePiece	-$24, -8, 2, 2, $C, 0, 0, 0, 0
	
	spritePiece	-4, -8, 2, 2, $2A, 0, 0, 0, 0
	spritePiece	$C, -8, 2, 2, 0, 0, 0, 0, 0
	spritePiece	$1C, -8, 2, 2, $3A, 0, 0, 0, 0
	spritePiece	 $2C, -8, 2, 2, 4, 0, 0, 0, 0
	spritePiece	 $3C, -8, 2, 2, $26, 0, 0, 0, 0
	spritePiece	 $4C, -8, 2, 2, $10, 0, 0, 0, 0
M_Card_MZ_End
	even

M_Card_SLZ:	spriteHeader		; STAR LIGHT
	spritePiece	-$64, -8, 2, 2, $26, 0, 0, 0, 0
	spritePiece	-$54, -8, 1, 2, $20, 0, 0, 0, 0
	spritePiece	-$4C, -8, 2, 2, $2A, 0, 0, 0, 0
	spritePiece	-$3C, -8, 1, 2, $20, 0, 0, 0, 0
	spritePiece	-$34, -8, 2, 2, $42, 0, 0, 0, 0
	...
	spritePiece	$24, -8, 2, 2, $18, 0, 0, 0, 0
...
M_Card_SYZ:	spriteHeader		; SPRING YARD
	spritePiece	-$6C, -8, 2, 2, $26, 0, 0, 0, 0
	spritePiece	-$5C, -8, 1, 2, $20, 0, 0, 0, 0
	spritePiece	-$54, -8, 2, 2, $2A, 0, 0, 0, 0
	spritePiece	-$44, -8, 1, 2, $20, 0, 0, 0, 0
	spritePiece	-$3C, -8, 2, 2, $42, 0, 0, 0, 0
	spritePiece	-$2C, -8, 2, 2, $10, 0, 0, 0, 0
	spritePiece	-$1C, -8, 2, 2, $C, 0, 0, 0, 0
	spritePiece	4, -8, 2, 2, $4A, 0, 0, 0, 0
	spritePiece	$14, -8, 2, 2, 0, 0, 0, 0, 0
	spritePiece	$24, -8, 2, 2, $3A, 0, 0, 0, 0
	spritePiece	$34, -8, 2, 2, $C, 0, 0, 0, 0
M_Card_SYZ_End
	even
...
M_Card_Zone:	spriteHeader		; ZONE
	...
	spritePiece	-$C, -8, 2, 2, $2A, 0, 0, 0, 0
	spritePiece	4, -8, 1, 2, $20, 0, 0, 0, 0
	spritePiece	$C, -8, 2, 2, $42, 0, 0, 0, 0
...
M_Got_Score:	spriteHeader		; SCORE
	...
	spritePiece	-$30, -8, 1, 2, $160, 0, 0, 0, 0
...
Obj_Index:
		...
		include	"_incObj/sub ObjectFallNoJump.asm"
...
Map_Cred:	include	"_maps/Credits.asm"
		...
		include	"_incObj/81 Credits - Good Ending.asm"
Map_Cred2:	include	"_maps/Credits - Good Ending.asm"
...
locret_1B60C:
		rts	
; ===========================================================================
SS_AniEmerData:	dc.b $46, $46, $46, $46, 0, 0
; ===========================================================================
